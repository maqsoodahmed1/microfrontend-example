...
export default function Banner({ className, title, description, buttonText, onButtonClick }: IBannerProps) {
    return (
        <div
            className={cn("flex flex-col relative justify-end bg-cover bg-center w-full h-[155px] rounded-t-3xl", className)}
        ...
        >
            ...
            <img className="absolute right-0 max-w-[170px] md:max-w-[350px]" src={WelcomeToDP} />
        </div>
    )
}
